...
async function loadTableData(isInitial = true) {
    try {
        ...
        console.error("Data load failed, applying fallback flights", e);
        flightData = [
            { time: "18:58", flight: "AI2996", terminal: "T2", airline: "AIR INDIA", city: "NEW DELHI", status: "ON TIME" },
            { time: "19:03", flight: "AI2641", terminal: "T2", airline: "AIR INDIA", city: "BENGALURU", status: "ON TIME" },
            { time: "19:08", flight: "6E5047", terminal: "T1", airline: "INDIGO", city: "BENGALURU", status: "ON TIME" },
            { time: "19:13", flight: "6E5147", terminal: "T1", airline: "INDIGO", city: "NAGPUR", status: "ON TIME" },
            { time: "19:25", flight: "UK985", terminal: "T2", airline: "VISTARA", city: "MUMBAI", status: "ON TIME" },
            { time: "19:40", flight: "SG8169", terminal: "T1", airline: "SPICEJET", city: "GOA", status: "ON TIME" },
            { time: "19:55", flight: "QP1332", terminal: "T1", airline: "AKASA AIR", city: "HYDERABAD", status: "ON TIME" }
        ];
        if (isInitial) currentPage = 0;
        renderPage();
    }
